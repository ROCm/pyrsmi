...
def resource_timeline(doc):
    ...
    memory_fig.line(source=source, x='time', y='memory', line_width=3)
    ...
    disk_fig.line(source=source, x='time', y='disk-read', color='blue', line_width=3, legend_label='Read')
    disk_fig.line(source=source, x='time', y='disk-write', color='orange', line_width=3, legend_label='Write')
    disk_fig.yaxis.formatter = NumeralTickFormatter(format='0.0b')
    # disk_fig.legend_location = 'top_left'
    ...
    # net_fig.legend_location = 'top_left'
